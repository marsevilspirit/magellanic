...
(() => {
  ...
  f &&
    !(Et = (g.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      g.readyState,
    )) &&
    ...
    t = zt(
      ...
      (t, e) => {
        ...
        return (
          ...
          "number" == typeof a &&
            (t.unicodes[a.toString(16)] = { prefix: r, iconName: n }),
          t
        );
      },
      { names: {}, unicodes: {} },
  ...
  function Qt(t, e) {
    ...
    var i = Jt(t.filter((t) => n.includes(t))),
      ...
      i = ((t) => {
        let a = l,
          r = Tt.reduce(
            (t, e) => ((t[e] = "".concat(x.cssPrefix, "-").concat(e)), t),
            {},
          );
        return (
          q.forEach((e) => {
  ...
  let ne = new (class {
      ...
      add() {
        ...
        Object.keys(r).forEach((t) => {
          ((this.definitions[t] = b(b({}, this.definitions[t] || {}), r[t])),
            Rt(t, r[t]));
          var e = dt[l][t];
          (e && Rt(e, r[t]), C());
        });
            ...
            : "object" == typeof t && t.prefix && t.iconName
              ...
              : Array.isArray(t) && 2 === t.length
                ...
                : "string" == typeof t &&
                  ...
                  ? {
                      prefix:
                        (a = Qt(t.split(" "), { skipLookups: !0 })).prefix || S,
  ...
  function de(i, o) {
    ...
    return (
      ...
      new Promise((t, e) => {
        ...
        if (
          ("fa" === s &&
            ((a = Vt(i) || {}), (i = a.iconName || i), (o = a.prefix || o)),
          i && o && fe[o] && fe[o][i])
        )
          return t(ce(fe[o][i]));
        ((r = i),
          ...
          t(
            b(
              ...
              {
                icon:
                  (x.showMissingIcons && i && I("missingIconAbstract")) || {},
              },
            ),
          ));
      })
    ...
    return new Promise((s, a) => {
      ...
      if (u && "none" !== t && "" !== t) {
        ...
        if (
          ...
          !e ||
            f ||
            (l && l.getAttribute(nt) === i && l.getAttribute(it) === o))
        )
          s();
        else {
        ...
        return {
          ...
          watch(t) {
            ...
            Ge
              ? Pe()
              : Ne(
                  ae("mutationObserverCallbacks", { observeMutationsRoot: e }),
                );
          },
        };
      },
  ...
  n = [
          ...
          var {
            ...
            s = {
              ...
              children: [
                $e(
                  b(
                    { tag: s.tag, attributes: b(b({}, s.attributes), o.path) },
                    r,
                  ),
                ),
              ],
    ...
    },
    {
      provides(t) {
        let i = !1;
        (e.matchMedia &&
          (i = e.matchMedia("(prefers-reduced-motion: reduce)").matches),
            ...
            return (
              i ||
                n.children.push(
                  ...
                  {
                    tag: "animate",
                    attributes: b(b({}, r), {}, { values: "1;0;1;1;0;1;" }),
                  },
                ),
              t.push(n),
              t.push({
                ...
                children: i
                  ...
                  : [
                      {
                        tag: "animate",
                        attributes: b(b({}, r), {}, { values: "1;0;0;0;0;1;" }),
                      },
                    ],
              }),
              i ||
                t.push({
                  ...
                  children: [
                    {
                      tag: "animate",
                      attributes: b(b({}, r), {}, { values: "0;0;1;1;0;0;" }),
                    },
                  ],
                }),
